...
const registerAccount = () => (axios.post("http://localhost8080/createaccount", {
...
return (
  <Container as="section" maxW="100hv" maxH="100hv" bg="#5D5D5D" pb="2em">
    ...
    <Center>
      ...
      <Center>
      <Box as="form" id="reg--form">
        <FormControl>
          <FormLabel>Username:</FormLabel>
          <Input sx={inputStyles} type="text" id="reg--username" name="username" onChange={(e) => {setRegisterUsername(e.target.value)}}/>
          <FormLabel>Email Address:</FormLabel>
          <Input sx={inputStyles} type="email" id="reg--email--1" name="email" onChange={(e) => {setRegisterEmail(e.target.value)}}/>
          <FormLabel>Password:</FormLabel>
          <Input sx={inputStyles} type="password" id="reg--password--1" placeholder="password" name="password" onChange={(e) => {setRegisterPassword(e.target.value)}}/>
          <Button sx={ButtonStyles} my="1em" type="submit" onClick={registerAccount}>Register</Button>
        </FormControl>
      </Box>
    </Center>
  </Container>
